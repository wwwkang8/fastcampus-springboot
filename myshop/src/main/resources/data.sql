...
insert into member(id, name, email, password, reg_date) values (1, 'kim', 'urstory@gmail.com', '{bcrypt}$2a$10$G5E3.paSJfHL1iG/Ccy.meLL2eu4I1S22nqqpShxYYU1QnNFzkiP2', now());

insert into member(id, name, email, password, reg_date) values (2, 'kang', 'carami@gmail.com', '{bcrypt}$2a$10$G5E3.paSJfHL1iG/Ccy.meLL2eu4I1S22nqqpShxYYU1QnNFzkiP2', now());
